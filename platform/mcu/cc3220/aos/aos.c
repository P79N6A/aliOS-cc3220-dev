...
extern hal_wifi_module_t sim_aos_wifi_cc3220;
...
{
    int ret = 0;
    hal_wifi_register_module(&sim_aos_wifi_cc3220);
    krhino_task_dyn_create(&g_slspawn, "SLSPAWN", 0, 9 /*AOS_DEFAULT_APP_PRI*/, 0, 1024, (task_entry_t)app_slspawn, 1);
    return ret;
}
